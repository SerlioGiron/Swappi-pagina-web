        ...
        <Card className="mt-6 w-[80vw] h-[20vh] md:w-[30vw] md:h-[30vh] items-center justify-center">
            <CardBody className="flex flex-row items-center justify-center gap-4">
                ...
                <div className="flex flex-col">
                    <Typography variant="h5" color="blue-gray" className=" text-black mb-2">
                        Ahorro económico
                    </Typography>
        ...
        <Card className="mt-6 w-[80vw] h-[20vh] md:w-[30vw] md:h-[30vh] items-center justify-center">
            <CardBody className="flex flex-row items-center justify-center gap-4">
                <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    class="mb-4 h-12 w-12 text-black"
                >
                    <path
                        fill-rule="evenodd"
...
export function Beneficios() {
    return (
        <div className="relative h-[120vh] md:h-[110vh]">
            ...
            <Typography
                color="blue-gray"
                className="text-3xl text-black font-bold text-center pt-10"
            >
                Beneficios
            </Typography>
